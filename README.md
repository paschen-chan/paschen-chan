...
<span style="color: #8b949e;">&gt;&gt;&gt;</span>  <span style="color: #7ee787;">[ Everything-passionator · Chief Life Artist ]</span>
     Hello-world developer crafting awesome apps in Nullday.
     <span style="color: #8b949e;">// Driven by curiosity, defined by aesthetics.</span>

<span style="color: #8b949e;">$</span> <span style="color: #79c0ff;">_</span><span style="display: inline-block; background: #e6edf3; width: 7px; height: 14px; margin-left: 2px; vertical-align: middle;"></span>
</pre>

### 👨‍💻 关于我

- 🔭 喜欢探索 **跨平台应用、Web 开发与原生技术**
- 🌱 正在持续深入 **Agent框架编排，全栈开发**
- 💬 可以找我聊聊 **客户端开发、静态站点、底层实现与产品审美**
- 🎨 相信好的软件应该 **实用、快速，并且有自己的风格**
- 📝 我的博客：**[thepaschen.com](https://thepaschen.com)**
